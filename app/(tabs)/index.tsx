import { Services, ThemedScrollView, ThemedText, ThemedTextInput, ThemedView } from "@/components";
      ...
      <ThemedScrollView style={{ flex: 1, paddingTop: 65, paddingHorizontal: 15 }}>
        <ThemedView style={{ height: "auto", display: "flex", justifyContent: "space-between", alignItems: 'center', flexDirection: 'row' }}>
          <View style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
            ...
            <View style={{ marginLeft: 10, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "flex-start", gap: 5 }}>
              <ThemedText style={{ fontSize: 16, fontWeight: '700' }}>Goummo Bill Boris</ThemedText>
        ...
        <View style={{ height: 149, backgroundColor: "#0ba4b4", paddingTop: 14, paddingHorizontal: 15, display: "flex", borderRadius: 9, marginTop: 27, flexDirection: 'column', gap: 4 }}>
          ...
          <View style={{ display: "flex", width: "100%", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
            <Text style={{ color: "#fcfcfc", fontWeight: "400", fontSize: 17 }}>XAF 2500</Text>
            <Button
              title="Fund Account"
              variant="contained"
              color="#0ba4b4"
          ...
          <Text style={{ color: "#fcfcfc", fontWeight: "normal", fontSize: 15 }}>XAF 60.00 commissions</Text>
        ...
        <ThemedView style={{ flexDirection: "column", flexWrap: "wrap", gap: 10, marginTop: 20 }}>
          <ThemedText style={{ fontSize: 17, fontWeight: "700" }}>Favourite Services</ThemedText>
          <Services />
        </ThemedView>
        <ThemedView style={{ marginTop: 20 }}>
          <ThemedText style={{ fontSize: 17, fontWeight: "700" }}>Categories</ThemedText>
        </ThemedView>
